...
class TorchModel(nn.Module):
    def __init__(self, input_dim, hidden_size, num_rnn_layers, vocab):
        ...
        #                     )
        self.bert = BertModel.from_pretrained(r"F:\AI\study\Project\bert\bert-base-chinese", return_dict=False)
...
if __name__ == "__main__":
    ...
    input_strings = ["同时国内有望出台新汽车刺激方案",
                     ...
                     "经过两个交易日的强势调整后",
                     "昨日上海天然橡胶期货价格再度大幅上扬"]
    predict(r"F:\AI\study\Project\bert\bert-base-chinese\pytorch_model.bin", "chars.txt", input_strings)